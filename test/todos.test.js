...
describe("Testing creation todo", function () {
    ...
    //     });
    //
    //     it("Should verify new todo if is created with default status 1", function (done) {
    //         todoactions.getTaskById(response.data.id, 200, false);
    //         done();
    //     });
    // });
    // describe("Create valid todo with  status 2", function () {
    //     let task = new Task("Tim todo", 2);
    //     var response;
    ...
    //     });
    //
    //     it("Should verify new todo if is created with status 2 ", function (done) {
    //         todoactions.getTaskById(response.data.id, 200, false);
    //         done();
    //     });
    // });
